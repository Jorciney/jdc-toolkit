export const conventionalComments = {
  ...
  "Suggestion": {
    "innerText": "$`\\colorbox{#17BD93}{\\textcolor{#FFFFFF}{\\textsf{Suggestion:}}}`$",
  ...
  "Issue": {
    "innerText": "$`\\colorbox{#FF47B6}{\\textcolor{#FFFFFF}{\\textsf{Issue:}}}`$",
  ...
  "Thought": {
    "innerText": "$`\\colorbox{#ADE9F0}{\\textcolor{#FFFFFF}{\\textsf{Thought:}}}`$",
  ...
  "Chore": {
    "innerText": "$`\\colorbox{#B2ADF0}{\\textcolor{#FFFFFF}{\\textsf{Chore:}}}`$",
  ...
  "Non-blocking": {
    "innerText": "$`\\colorbox{gray}{\\textcolor{#FFFFFF}{\\textsf{Non-blocking:}}}`$",
  ...
  "Minor": {
    "innerText": "$`\\colorbox{#777777}{\\textcolor{#FFFFFF}{\\textsf{Minor:}}}`$",
